                        ...
                        <div class="col-lg-4 col-md-6 items web info-overlay mb-50">
                            <div class="item-img o-hidden">
                                ...
                                <div class="info">
                                    ...
                                    <h6 class="sub-title tag"><a href="project-details1.html">© 2023 <br> Digital Design</a></h6>
                        ...
                        <div class="col-lg-4 col-md-6 items brand info-overlay mb-50">
                            <!-- <div class="item-img o-hidden">
                                <a href="project-details1.html" class="imago wow">
                                    <div class="inner wow">
                                        <img src="assets/imgs/works/grid2/3.jpg" alt="image">
                                    </div>
                                </a>
                                <div class="info">
                                    <span class="mb-15">
                                    ...
                                    <h6 class="sub-title tag"><a href="project-details1.html">© 2023 <br> Design ART</a></h6>
